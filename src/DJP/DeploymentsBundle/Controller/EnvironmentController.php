...
class EnvironmentController extends Controller
{
     ...
     *
     * @Route("/", name="environment_create")
     * @Method("POST")
     * @Template("DJPDeploymentsBundle:Environment:new.html.twig")
     */
    ...
    */
     ...
     *
     * @Route("/{id}", name="environment_update")
     * @Method("PUT")
     * @Template("DJPDeploymentsBundle:Environment:edit.html.twig")
     */
